  ...
  return (
    <div className="snap-container">
      <article className="max-w-350 text-center snap-section items-center">
        <h1 className="custom-h1 custom-stroke">
          Welcome to my{" "}
          <p className="inline custom-blue">"What Do I Have To Do"</p> app !
        </h1>
        <p className="mt-5 text-4xl font-bold custom-stroke text-gray-50">
        ...
        <p className="mt-10 max-w-300 text-3xl font-bold custom-stroke text-gray-50">
      ...
      <article className="max-w-350 text-center snap-section items-center">
        ...
        <div className="mt-5 max-w-300 justify-items-center">
          <p className="inline custom-blue text-3xl font-bold custom-stroke text-gray-50">
            REGISTER
          </p>
          <p className="inline text-2xl font-bold custom-stroke text-gray-50">
            {" - "} Simple registration form, without any validations for now.
          </p>
          <p className="max-w-200 text-2xl font-bold custom-stroke text-gray-50">
